...
public class CheapoairTest extends Base {
	...
	public void testFlightOrder() throws InterruptedException {
	   ...
	   org.openqa.selenium.support.ui.Select childAge1 = new org.openqa.selenium.support.ui.Select(driver.findElement(By.name("ChildrenAge")));
	   childAge1.selectByIndex(1);
	   
	   WebElement childAge2 = driver.findElement(By.id("select1"));
		childAge2.click();
		org.openqa.selenium.support.ui.Select child2Age = new org.openqa.selenium.support.ui.Select(driver.findElement(By.name("ChildrenAge")));
